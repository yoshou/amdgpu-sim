...
fn check_vop2_f32(op: u32, cases: &[Vop2F32]) {
    ...
    for (i, case) in cases.iter().enumerate() {
        ...
        let field = match case.src0 {
            ...
            Src::Literal(_) => unreachable!("VOP2 literals are not covered yet"),
        };
        for lane in 0..LANES {
...
fn v_sub_f32_vop2() {
    ...
    check_vop2_f32(
        ...
        &[
            ...
            Vop2F32 { src0: Src::Vgpr(HALF as u64), vsrc1: 0x3F80_0000, expected: 0xBF00_0000 },
            Vop2F32 { src0: Src::Vgpr(0x7F80_0000), vsrc1: 0x7F80_0000, expected: 0xFFC0_0000 },
            Vop2F32 { src0: Src::Vgpr(0x7FA0_0000), vsrc1: 0x3F80_0000, expected: 0x7FE0_0000 },
