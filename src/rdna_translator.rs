                        ...
                        if USE_SIMD {
                            ...
                            for i in (0..32).step_by(8) {
                                ...
                                let s0_value = emitter
                                    .emit_vector_source_operand_u32x8(&inst.src0, elem, mask);
                    ...
                    match inst.opx {
                        I::V_DUAL_CNDMASK_B32 => {
                            ...
                            for i in (0..32).step_by(8) {
                                ...
                                let s0_value = emitter.emit_vector_source_operand_u32x8(
                                    &inst.src0x,
                                    elem,
                                    mask,
                                );
