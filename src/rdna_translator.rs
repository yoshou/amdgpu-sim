...
impl IREmitter {
    unsafe fn get_intrinsic_declaration(
        &mut self,
        name: &str,
        ...
        llvm::core::LLVMGetIntrinsicDeclaration(
            self.module,
            intrinsic_id,
    ...
    unsafe fn emit_vop1(
        ...
        match inst.op {
            ...
            I::V_READFIRSTLANE_B32 => {
                ...
                let elem = llvm::core::LLVMBuildZExt(builder, elem, ty_i64, empty_name.as_ptr());
            ...
            I::V_CLZ_I32_U32 => {
                if USE_SIMD {
                    ...
                    for i in (0..32).step_by(N) {
                        ...
                        let mut param_tys = vec![ty_i32xn, ty_i1];
                        let d_value = llvm::core::LLVMBuildCall2(
                            builder,
                            llvm::core::LLVMFunctionType(
                                ty_i32xn,
            ...
            I::V_ADD_CO_CI_U32 => {
                if USE_SIMD {
                    ...
                    bb = self.emit_vop_update_sgpr(bb, 106, |emitter, bb, elem| {
                        ...
                        let elem_i32 =
                            llvm::core::LLVMBuildTrunc(builder, elem, ty_i32, empty_name.as_ptr());
            ...
            I::V_CMP_CLASS_F32 => {
                if USE_SIMD {
                    ...
                    for i in (0..32).step_by(N) {
                        ...
                        for cls in 0..10 {
                            ...
                            let class_value = llvm::core::LLVMBuildCall2(
                                builder,
                                llvm::core::LLVMFunctionType(ty_i1xn, param_tys.as_mut_ptr(), 2, 0),
                                intrinsic,
                    ...
                    bb = self.emit_vop_update_sgpr(bb, inst.vdst as u32, |emitter, bb, elem| {
                        ...
                        let class_value = llvm::core::LLVMBuildCall2(
                            builder,
                            llvm::core::LLVMFunctionType(ty_i1, param_tys.as_mut_ptr(), 2, 0),
                            intrinsic,
                            [s0_value, s1_value].as_mut_ptr(),
                            2,
                            empty_name.as_ptr(),
            ...
            I::V_TRIG_PREOP_F64 => {
                if USE_SIMD {
                    ...
                    for i in (0..32).step_by(N) {
                        ...
                        let index_i32 =
                            llvm::core::LLVMBuildTrunc(builder, index, ty_i32, empty_name.as_ptr());
                        ...
                        for j in 0..2 {
                            for k in 0..2 {
                                for l in 0..2 {
                                    ...
                                    let row = llvm::core::LLVMConstInt(ty_i64, (i % 16) as u64, 0);
                ...
                if USE_SIMD {
                    ...
                    for i in (0..32).step_by(N) {
                        ...
                        llvm::core::LLVMBuildCall2(
                            ...
                            intrinsic,
                            [value, ptr, llvm::core::LLVMConstInt(ty_i32, 2, 0), mask].as_mut_ptr(),
                            4,
                            empty_name.as_ptr(),
                        );
                    }
                ...
                if USE_SIMD {
                    ...
                    for i in (0..32).step_by(N) {
                        ...
                        llvm::core::LLVMBuildCall2(
                            ...
                            intrinsic,
                            [value, ptr, llvm::core::LLVMConstInt(ty_i32, 1, 0), mask].as_mut_ptr(),
                            4,
                            empty_name.as_ptr(),
                        );
                    }
