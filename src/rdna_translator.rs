...
impl IREmitter {
    ...
    unsafe fn emit_loop(
        ...
        let cmp = llvm::core::LLVMBuildICmp(
            ...
            next_index,
            llvm::core::LLVMConstInt(ty_i64, n, 0),
            empty_name.as_ptr(),
        );
    ...
    unsafe fn emit_load_vgpr_f16xn<const N: usize>(
        &mut self,
        reg: u32,
        elem: u32,
        mask: llvm::prelude::LLVMValueRef,
    ...
    unsafe fn emit_store_sgpr_f32(&mut self, reg: u32, value: llvm::prelude::LLVMValueRef) {
        let context = self.context;
        let builder = self.builder;
    ...
    unsafe fn emit_vector_source_operand_f32_vec(
        &mut self,
        operand: &SourceOperand,
        elem: llvm::prelude::LLVMValueRef,
    ...
    unsafe fn emit_vector_source_operand_f16(
        &mut self,
        operand: &SourceOperand,
        elem: llvm::prelude::LLVMValueRef,
    ) -> llvm::prelude::LLVMValueRef {
    ...
    unsafe fn emit_vector_source_operand_f32xn_vec<const N: usize>(
        &mut self,
        operand: &SourceOperand,
        elem: u32,
        mask: llvm::prelude::LLVMValueRef,
    ...
    unsafe fn emit_vector_source_operand_f16xn<const N: usize>(
        &mut self,
        operand: &SourceOperand,
        elem: u32,
        mask: llvm::prelude::LLVMValueRef,
    ...
    unsafe fn emit_vector_source_operand_f16xn_vec<const N: usize>(
        &mut self,
        operand: &SourceOperand,
        elem: u32,
        mask: llvm::prelude::LLVMValueRef,
    ...
    unsafe fn emit_abs_f32(
        ...
        let abs_value = llvm::core::LLVMBuildCall2(
            builder,
            llvm::core::LLVMFunctionType(ty_f32, param_tys.as_mut_ptr(), 1, 0),
            intrinsic,
            [value].as_mut_ptr(),
            1,
            empty_name.as_ptr(),
    ...
    unsafe fn emit_abs_f32xn<const N: usize>(
        &mut self,
        value: llvm::prelude::LLVMValueRef,
    ) -> llvm::prelude::LLVMValueRef {
        let context = self.context;
        ...
        let abs_value = llvm::core::LLVMBuildCall2(
            builder,
            llvm::core::LLVMFunctionType(ty_f32xn, param_tys.as_mut_ptr(), 1, 0),
            intrinsic,
            [value].as_mut_ptr(),
            1,
            empty_name.as_ptr(),
    ...
    unsafe fn emit_fract_f32xn<const N: usize>(
        &mut self,
        value: llvm::prelude::LLVMValueRef,
    ) -> llvm::prelude::LLVMValueRef {
        let context = self.context;
    ...
    unsafe fn emit_exp_f32xn<const N: usize>(
        &mut self,
        value: llvm::prelude::LLVMValueRef,
    ) -> llvm::prelude::LLVMValueRef {
        let context = self.context;
    ...
    unsafe fn emit_abs_neg_f32xn<const N: usize>(
        &mut self,
        value: llvm::prelude::LLVMValueRef,
        abs: u8,
        neg: u8,
    ...
    unsafe fn emit_fma_f32xn<const N: usize>(
        &mut self,
        ...
        let mut param_tys = vec![ty_f32xn, ty_f32xn, ty_f32xn];
        let fma_value = llvm::core::LLVMBuildCall2(
            builder,
            llvm::core::LLVMFunctionType(ty_f32xn, param_tys.as_mut_ptr(), 3, 0),
            intrinsic,
    ...
    unsafe fn emit_exp2_f32xn<const N: usize>(
        &mut self,
        value0: llvm::prelude::LLVMValueRef,
    ) -> llvm::prelude::LLVMValueRef {
        let context = self.context;
    ...
    unsafe fn emit_ldexp_f32(
        ...
        let ldexp_value = llvm::core::LLVMBuildCall2(
            builder,
            llvm::core::LLVMFunctionType(ty_f32, param_tys.as_mut_ptr(), 2, 0),
            intrinsic,
            [value0, value1].as_mut_ptr(),
            2,
            empty_name.as_ptr(),
    ...
    unsafe fn emit_instruction(
        ...
        match inst {
            ...
            InstFormat::VOPC(inst) => match inst.op {
                ...
                I::V_CMPX_NE_U32 | I::V_CMPX_LT_U32 | I::V_CMPX_EQ_U32 => {
                    let pred = match inst.op {
                ...
                I::V_FMAC_F32 => {
                    if USE_SIMD {
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            let d_value =
                                emitter.emit_load_vgpr_f32xn::<N>(inst.vdst as u32, i, mask);
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let mut param_tys = vec![ty_f32, ty_f32, ty_f32];

                            let d_value = llvm::core::LLVMBuildCall2(
                                builder,
                                llvm::core::LLVMFunctionType(ty_f32, param_tys.as_mut_ptr(), 3, 0),
                                intrinsic,
                                [s0_value, s1_value, d_value].as_mut_ptr(),
                                3,
                                empty_name.as_ptr(),
                            );
                    ...
                    if USE_SIMD {
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let d_value = llvm::core::LLVMBuildCall2(
                                ...
                                llvm::core::LLVMFunctionType(ty_f32, param_tys.as_mut_ptr(), 3, 0),
                                intrinsic,
                                [s0_value, k_value, s1_value].as_mut_ptr(),
                                3,
                                empty_name.as_ptr(),
                            );
                    ...
                    if USE_SIMD {
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let d_value = llvm::core::LLVMBuildCall2(
                                ...
                                llvm::core::LLVMFunctionType(ty_f32, param_tys.as_mut_ptr(), 3, 0),
                                intrinsic,
                                [s0_value, s1_value, k_value].as_mut_ptr(),
                                3,
                                empty_name.as_ptr(),
                            );
                ...
                I::V_CNDMASK_B32 => {
                    if USE_SIMD {
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let s0_value =
                                emitter.emit_abs_neg_f32(inst.abs, inst.neg, s0_value, 0);
                            let s1_value =
                                emitter.emit_abs_neg_f32(inst.abs, inst.neg, s1_value, 1);
                    ...
                    if USE_SIMD {
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            for cls in 0..10 {
                                ...
                                let mut param_tys = vec![ty_f32xn, ty_i32];
                    ...
                    if USE_SIMD {
                        ...
                        bb =
                            self.emit_vop_update_sgpr(bb, inst.vdst as u32, |emitter, bb, elem| {
                                ...
                                let s0_value =
                                    emitter.emit_abs_neg_f64(inst.abs, inst.neg, s0_value, 0);
                                let s1_value =
                                    emitter.emit_abs_neg_f64(inst.abs, inst.neg, s1_value, 1);
                    ...
                    if USE_SIMD {
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let s1_value =
                                emitter.emit_abs_neg_f64(inst.abs, inst.neg, s1_value, 1);
                            let s2_value =
                                emitter.emit_abs_neg_f64(inst.abs, inst.neg, s2_value, 2);
                    ...
                    if USE_SIMD {
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let s1_value =
                                emitter.emit_abs_neg_f32(inst.abs, inst.neg, s1_value, 1);
                            let s2_value =
                                emitter.emit_abs_neg_f32(inst.abs, inst.neg, s2_value, 2);
                ...
                I::V_DIV_FMAS_F32 => {
                    if USE_SIMD {
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            let fma_result =
                                emitter.emit_fma_f32xn::<N>(s0_value, s1_value, s2_value);
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let muled = emitter.emit_ldexp_f32(
                                fma_result,
                ...
                I::V_DIV_SCALE_F32 => {
                    if USE_SIMD {
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            let s0_value =
                                emitter.emit_abs_neg_f32xn::<N>(s0_value, 0, inst.neg, 0);

                            let s1_value =
                                emitter.emit_abs_neg_f32xn::<N>(s1_value, 0, inst.neg, 1);

                            let s2_value =
                                emitter.emit_abs_neg_f32xn::<N>(s2_value, 0, inst.neg, 2);
                ...
                I::V_WMMA_F32_16X16X16_F16 => {
                    if USE_SIMD {
                        ...
                        let matrix_a = llvm::core::LLVMBuildArrayAlloca(
                            builder,
                            ty_f32xn,
                            llvm::core::LLVMConstInt(ty_i64, 16 * 16 / N as u64, 0),
                            empty_name.as_ptr(),
                        ); // col major
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            let s0_value = emitter
                                .emit_vector_source_operand_f16xn_vec::<N>(&inst.src0, i, mask);

                            let s1_value = emitter
                                .emit_vector_source_operand_f16xn_vec::<N>(&inst.src1, i, mask);

                            let s2_value = emitter
                                .emit_vector_source_operand_f32xn_vec::<N>(&inst.src2, i, mask);
                            ...
                            for j in 0..2 {
                                for k in 0..2 {
                                    for l in 0..2 {
                                        ...
                                        let row =
                                            llvm::core::LLVMConstInt(ty_i64, (i % 16) as u64, 0);
                                        ...
                                        let idx = llvm::core::LLVMBuildAdd(
                                            ...
                                            llvm::core::LLVMBuildMul(
                                                builder,
                                                col,
                                                llvm::core::LLVMConstInt(ty_i64, 16, 0),
                                                empty_name.as_ptr(),
                                            ),
                                            row,
                                            empty_name.as_ptr(),
                            ...
                            for j in 0..2 {
                                for k in 0..2 {
                                    for l in 0..2 {
                                        ...
                                        let ptr: *mut llvm_sys::LLVMValue =
                            ...
                            for j in 0..8 {
                                let row =
                                    llvm::core::LLVMConstInt(ty_i64, (j + (i / 16) * 8) as u64, 0);

                                let col = llvm::core::LLVMConstInt(ty_i64, (i % 16) as u64, 0);
                        ...
                        bb = emitter.emit_loop(bb, 16, |emitter, bb, i| {
                            let bb = emitter.emit_loop(bb, 16, |emitter, bb, j| {
                                ...
                                let (bb, value) = emitter.emit_loop_reduce(
                                    bb,
                                    value,
                                    16,
                                    |emitter, bb, value, k| {
                        ...
                        let matrix_a = llvm::core::LLVMBuildArrayAlloca(
                            builder,
                            ty_f32,
                            llvm::core::LLVMConstInt(ty_i64, 16 * 16, 0),
                            empty_name.as_ptr(),
                        ); // row major
                        let matrix_b = llvm::core::LLVMBuildArrayAlloca(
                            builder,
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            let s0_value =
                                emitter.emit_vector_source_operand_f16_vec(&inst.src0, elem);
                            let s1_value =
                                emitter.emit_vector_source_operand_f16_vec(&inst.src1, elem);
                            let s2_value =
                                emitter.emit_vector_source_operand_f32_vec(&inst.src2, elem);
                                    ...
                                    for k in 0..2 {
                                        let col = llvm::core::LLVMBuildAdd(
                                            ...
                                            llvm::core::LLVMBuildMul(
                                                ...
                                                llvm::core::LLVMConstInt(ty_i64, 4, 0),
                                                empty_name.as_ptr(),
                                            ),
                                            empty_name.as_ptr(),
                                        );
                            ...
                            for i in 0..8 {
                                let row = llvm::core::LLVMBuildAdd(
                                    builder,
                                    llvm::core::LLVMConstInt(ty_i64, i as u64, 0),
                                    llvm::core::LLVMBuildMul(
                                        builder,
                                        llvm::core::LLVMBuildUDiv(
                                            builder,
                ...
                I::V_FMA_MIXLO_F16 => {
                    if USE_SIMD {
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let s1_value =
                                emitter.emit_abs_neg_f32(inst.neg_hi, inst.neg, s1_value, 1);
                            let s2_value =
                                emitter.emit_abs_neg_f32(inst.neg_hi, inst.neg, s2_value, 2);
                ...
                match inst.opx {
                    ...
                    I::V_DUAL_SUB_F32 => {
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            let s1_value =
                                emitter.emit_load_vgpr_f32xn::<N>(inst.vsrc1x as u32, i, mask);
                ...
                match inst.opy {
                    ...
                    I::V_DUAL_ADD_F32 => {
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            let s1_value =
                                emitter.emit_load_vgpr_f32xn::<N>(inst.vsrc1y as u32, i, mask);
                ...
                I::FLAT_LOAD_B32 | I::FLAT_LOAD_B64 | I::FLAT_LOAD_B128 => {
                    ...
                    if USE_SIMD {
                        ...
                        let vscratch_limit_value = llvm::core::LLVMBuildAdd(
                            ...
                            vscratch_base_value,
                            llvm::core::LLVMConstVector(
                                [llvm::core::LLVMConstInt(ty_i64, emitter.scratch_size as u64, 0);
                                    N]
                                    .as_mut_ptr(),
                                N as u32,
                            ),
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            let addr_value = emitter.emit_load_vgpr_u64xn::<N>(
                                inst.vaddr as u32,
                                i as u32,
                                mask,
                            );
                            ...
                            let elem_offset = llvm::core::LLVMConstVector(
                                (0..N)
                                    .map(|n| {
                                        llvm::core::LLVMConstInt(ty_i64, (i + n as u64) * 4, 0)
                                    })
                                    .collect::<Vec<_>>()
                                    .as_mut_ptr(),
                                N as u32,
                        ...
                        for i in 0..32 {
                            ...
                            let exec = emitter.emit_exec_bit(elem_i32);
                ...
                I::GLOBAL_STORE_B16 => {
                    if USE_SIMD {
                        ...
                        for i in (0..32).step_by(N) {
                            ...
                            let intrinsic_name =
                                format!("llvm.masked.scatter.v{}i16.v{}p0\0", N, N);
                            let mut param_tys = vec![ty_i16xn, ty_p0xn];
                            ...
                            let mut param_tys = vec![ty_i16xn, ty_p0xn, ty_i32, ty_i1xn];
                            llvm::core::LLVMBuildCall2(
                                builder,
                                llvm::core::LLVMFunctionType(
                                    ty_void,
            ...
            InstFormat::SOPK(inst) => match inst.op {
                I::S_MOVK_I32 => {
                    ...
                    let d_value =
                        llvm::core::LLVMConstInt(ty_i32, inst.simm16 as i16 as i64 as u64, 0);
                ...
                I::IMAGE_BVH64_INTERSECT_RAY => {
                    if USE_SIMD {
                        ...
                        bb = self.emit_vop(bb, |emitter, bb, elem| {
                            ...
                            let ray_origin_y =
                                emitter.emit_load_vgpr_f32(inst.vaddr2 as u32 + 1, elem);
                            let ray_origin_z =
                                emitter.emit_load_vgpr_f32(inst.vaddr2 as u32 + 2, elem);
                            let ray_dir_x = emitter.emit_load_vgpr_f32(inst.vaddr3 as u32, elem);
                            let ray_dir_y =
                                emitter.emit_load_vgpr_f32(inst.vaddr3 as u32 + 1, elem);
                            let ray_dir_z =
                                emitter.emit_load_vgpr_f32(inst.vaddr3 as u32 + 2, elem);
                            let ray_inv_dir_x =
                                emitter.emit_load_vgpr_f32(inst.vaddr4 as u32, elem);
                            let ray_inv_dir_y =
                            ...
                            let return_ty = llvm::core::LLVMStructTypeInContext(
                                context,
                                [ty_i32, ty_i32, ty_i32, ty_i32].as_mut_ptr(),
                                4,
                                0,
                            );
                            let mut param_tys = vec![
                            ...
                            let result = llvm::core::LLVMBuildAlloca(
                                builder,
                                return_ty,
                                empty_name.as_ptr(),
                            );
...
impl RegisterUsage {
    ...
    fn use_operand_u16(&mut self, operand: &SourceOperand) {
        match operand {
    ...
    fn use_operand_f16_vec<const N: usize>(&mut self, operand: &SourceOperand) {
        match operand {
    ...
    fn use_operand_f32_vec<const N: usize>(&mut self, operand: &SourceOperand) {
        match operand {
            SourceOperand::ScalarRegister(reg) => {
                for i in 0..N {
    ...
    fn def_sgpr_f32(&mut self, reg: u32) {
    ...
    fn def_vgpr_u16(&mut self, reg: u32) {
    ...
    fn def_vgpr_f32_vec<const N: usize>(&mut self, reg: u32) {
        for i in 0..N {
