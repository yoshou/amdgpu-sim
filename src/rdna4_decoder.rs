...
fn decode_vglobal_opcode_rdna4(opcode: u32) -> Result<(I, usize), ()> {
    match opcode {
        ...
        58 => Ok((I::GLOBAL_ATOMIC_MAX_I32, 12)),
        59 => Ok((I::GLOBAL_ATOMIC_MAX_U32, 12)),
        60 => Ok((I::GLOBAL_ATOMIC_AND_B32, 12)),
        61 => Ok((I::GLOBAL_ATOMIC_OR_B32, 12)),
        62 => Ok((I::GLOBAL_ATOMIC_XOR_B32, 12)),
        63 => Ok((I::GLOBAL_ATOMIC_INC_U32, 12)),
        ...
        73 => Ok((I::GLOBAL_ATOMIC_AND_B64, 12)),
        74 => Ok((I::GLOBAL_ATOMIC_OR_B64, 12)),
        75 => Ok((I::GLOBAL_ATOMIC_XOR_B64, 12)),
        76 => Ok((I::GLOBAL_ATOMIC_INC_U64, 12)),
        77 => Ok((I::GLOBAL_ATOMIC_DEC_U64, 12)),
...
fn decode_vsample_opcode_rdna4(opcode: u32) -> Result<(I, usize), ()> {
    match opcode {
        24 => Ok((I::IMAGE_MSAA_LOAD, 12)),
        27 => Ok((I::IMAGE_SAMPLE, 12)),
        28 => Ok((I::IMAGE_SAMPLE_D, 12)),
        29 => Ok((I::IMAGE_SAMPLE_L, 12)),
        30 => Ok((I::IMAGE_SAMPLE_B, 12)),
        31 => Ok((I::IMAGE_SAMPLE_LZ, 12)),
        32 => Ok((I::IMAGE_SAMPLE_C, 12)),
        33 => Ok((I::IMAGE_SAMPLE_C_D, 12)),
        34 => Ok((I::IMAGE_SAMPLE_C_L, 12)),
        35 => Ok((I::IMAGE_SAMPLE_C_B, 12)),
        36 => Ok((I::IMAGE_SAMPLE_C_LZ, 12)),
        37 => Ok((I::IMAGE_SAMPLE_O, 12)),
        38 => Ok((I::IMAGE_SAMPLE_D_O, 12)),
        39 => Ok((I::IMAGE_SAMPLE_L_O, 12)),
        40 => Ok((I::IMAGE_SAMPLE_B_O, 12)),
        41 => Ok((I::IMAGE_SAMPLE_LZ_O, 12)),
        42 => Ok((I::IMAGE_SAMPLE_C_O, 12)),
        43 => Ok((I::IMAGE_SAMPLE_C_D_O, 12)),
        44 => Ok((I::IMAGE_SAMPLE_C_L_O, 12)),
        45 => Ok((I::IMAGE_SAMPLE_C_B_O, 12)),
        46 => Ok((I::IMAGE_SAMPLE_C_LZ_O, 12)),
        47 => Ok((I::IMAGE_GATHER4, 12)),
        48 => Ok((I::IMAGE_GATHER4_L, 12)),
        49 => Ok((I::IMAGE_GATHER4_B, 12)),
        50 => Ok((I::IMAGE_GATHER4_LZ, 12)),
        51 => Ok((I::IMAGE_GATHER4_C, 12)),
        52 => Ok((I::IMAGE_GATHER4_C_LZ, 12)),
        53 => Ok((I::IMAGE_GATHER4_O, 12)),
        54 => Ok((I::IMAGE_GATHER4_LZ_O, 12)),
        55 => Ok((I::IMAGE_GATHER4_C_LZ_O, 12)),
        56 => Ok((I::IMAGE_GET_LOD, 12)),
        57 => Ok((I::IMAGE_SAMPLE_D_G16, 12)),
        58 => Ok((I::IMAGE_SAMPLE_C_D_G16, 12)),
        59 => Ok((I::IMAGE_SAMPLE_D_O_G16, 12)),
        60 => Ok((I::IMAGE_SAMPLE_C_D_O_G16, 12)),
        64 => Ok((I::IMAGE_SAMPLE_CL, 12)),
        65 => Ok((I::IMAGE_SAMPLE_D_CL, 12)),
        66 => Ok((I::IMAGE_SAMPLE_B_CL, 12)),
        67 => Ok((I::IMAGE_SAMPLE_C_CL, 12)),
        68 => Ok((I::IMAGE_SAMPLE_C_D_CL, 12)),
        69 => Ok((I::IMAGE_SAMPLE_C_B_CL, 12)),
        70 => Ok((I::IMAGE_SAMPLE_CL_O, 12)),
        71 => Ok((I::IMAGE_SAMPLE_D_CL_O, 12)),
        72 => Ok((I::IMAGE_SAMPLE_B_CL_O, 12)),
        73 => Ok((I::IMAGE_SAMPLE_C_CL_O, 12)),
        74 => Ok((I::IMAGE_SAMPLE_C_D_CL_O, 12)),
        75 => Ok((I::IMAGE_SAMPLE_C_B_CL_O, 12)),
        84 => Ok((I::IMAGE_SAMPLE_C_D_CL_G16, 12)),
        85 => Ok((I::IMAGE_SAMPLE_D_CL_O_G16, 12)),
        86 => Ok((I::IMAGE_SAMPLE_C_D_CL_O_G16, 12)),
        95 => Ok((I::IMAGE_SAMPLE_D_CL_G16, 12)),
        96 => Ok((I::IMAGE_GATHER4_CL, 12)),
        97 => Ok((I::IMAGE_GATHER4_B_CL, 12)),
        98 => Ok((I::IMAGE_GATHER4_C_CL, 12)),
        99 => Ok((I::IMAGE_GATHER4_C_L, 12)),
        100 => Ok((I::IMAGE_GATHER4_C_B, 12)),
        101 => Ok((I::IMAGE_GATHER4_C_B_CL, 12)),
        144 => Ok((I::IMAGE_GATHER4H, 12)),
        _ => Err(()),
    }
}
...
pub fn decode_rdna4(inst_stream: InstStream) -> Result<(InstFormat, usize), ()> {
    ...
    } else if (get_bits(inst, 31, 26) as u32) == VSAMPLE_ENCODE {
        let inst_hi = buffer::get_u32(inst_stream.insts, 8) as u64;
        let (op, size) = decode_vsample_opcode_rdna4(get_bits(inst, 21, 14) as u32)?;
        Ok((
            InstFormat::VSAMPLE(VSAMPLE {
                op,
                dim: get_bits(inst, 2, 0) as u8,
                tfe: get_bits(inst, 3, 3) as u8,
                r128: get_bits(inst, 4, 4) as u8,
                d16: get_bits(inst, 5, 5) as u8,
                a16: get_bits(inst, 6, 6) as u8,
                unrm: get_bits(inst, 13, 13) as u8,
                dmask: get_bits(inst, 25, 22) as u8,
                vdata: get_bits(inst, 39, 32) as u8,
                lwe: get_bits(inst, 40, 40) as u8,
                rsrc: get_bits(inst, 49, 41) as u16,
                scope: get_bits(inst, 51, 50) as u8,
                th: get_bits(inst, 54, 52) as u8,
                samp: get_bits(inst, 63, 55) as u16,
                vaddr0: get_bits(inst_hi, 71 - 64, 64 - 64) as u8,
                vaddr1: get_bits(inst_hi, 79 - 64, 72 - 64) as u8,
                vaddr2: get_bits(inst_hi, 87 - 64, 80 - 64) as u8,
                vaddr3: get_bits(inst_hi, 95 - 64, 88 - 64) as u8,
